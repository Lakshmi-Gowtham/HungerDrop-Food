                                ...
                                <div class="item">
                                    <div class="card card-product">
                                        ...
                                        <div class="card-badge">
                                            ...
                                            <img src="<?php echo IMGURLPRODUCT; ?>/<?php echo $allmostProduct->image; ?>" alt="Card image 2" class="card-img-top" style="width: 265px; height: 265px;">
                                        </div>
                                        <div class="card-body">
                                            <h4 class="card-title">
                                            ...
                                            <div class="card-price">
                                                ...
                                                <span class="reguler">Rs <?php echo $allmostProduct->price; ?>/-</span>
                                            </div>
                                ...
                                <div class="item">
                                    <div class="card card-product">
                                        ...
                                        <div class="card-badge">
                                            ...
                                            <img src="<?php echo IMGURLPRODUCT; ?>/<?php echo $allvigi->image; ?>" alt="Card image 2" class="card-img-top" style="width: 265px; height: 265px;">
                                        </div>
                                        <div class="card-body">
                                            <h4 class="card-title">
                            ...
                            <div class="item">
                                <div class="card card-product">
                                    ...
                                    <div class="card-badge">
                                        ...
                                        <img src="<?php echo IMGURLPRODUCT; ?>/paneer-tikka.png" alt="Card image 2" class="card-img-top" style="width: 265px; height: 265px;">
                                    </div>
                                    <div class="card-body">
                                        <h4 class="card-title">
                                ...
                                <div class="item">
                                    <div class="card card-product">
                                        ...
                                        <div class="card-badge">
                                            ...
                                            <img src="<?php echo IMGURLPRODUCT; ?>/<?php echo $fish->image; ?>" alt="Card image 2" class="card-img-top" style="width: 265px; height: 265px;">
                                        </div>
                                        <div class="card-body">
                                            <h4 class="card-title">
                                            ...
                                            <div class="card-price">
                                                <!-- <span class="discount">Rp. 300.000</span> -->
                                                <span class="reguler">Rs. <?php echo $fish->price; ?>/-</span>
                                            </div>
                                ...
                                <div class="item">
                                    <div class="card card-product">
                                        ...
                                        <div class="card-badge">
                                            ...
                                            <img src="<?php echo IMGURLPRODUCT; ?>/<?php echo $fruit->image; ?>" alt="Card image 2" class="card-img-top" style="width: 265px; height: 265px;">
                                        </div>
                                        <div class="card-body">
                                            <h4 class="card-title">
