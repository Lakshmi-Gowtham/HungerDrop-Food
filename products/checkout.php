<?php 
    ...
    if(!isset($_SERVER['HTTP_REFERER'])){
        ...
        header('location: http://localhost/food-delivery/index.php');
        exit;
    }
    ...
    if(isset($_POST['submit'])) {
        ...
        OR empty($_POST['order_notes'])) {
           ...
           country, zip_code, email, phone_number, order_notes,  price, user_id)
            ...
            echo "<script> alert('Order was placed')</script>";
                                ...
                                <table class="table">
                                    ...
                                    <tfooter>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-right">
                                                <strong>Rs. <?php echo $_SESSION['price'] + 20; ?></strong>/-
                                            </td>
                                        </tr>
                                    </tfooter>
                                </table>
