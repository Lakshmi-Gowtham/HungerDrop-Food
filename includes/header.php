<?php 
    ...
    session_start();
    define("APPURL","http://localhost/food-delivery");
    
    define("IMGURLCATEGORY", "http://localhost/food-delivery/admin-panel/categories-admins/img_category");
    define("IMGURLPRODUCT", "http://localhost/food-delivery/admin-panel/products-admins/img_product");
...
<html>
<head>
    <title>HungerDrop | Food Delivery Store</title>
    <meta charset="utf-8">
